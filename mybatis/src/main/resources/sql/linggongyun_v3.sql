...
CREATE TABLE `tb_company_info` (
  ...
  `company_s_name` VARCHAR(20) NOT NULL COMMENT '公司的简称',
  ...
  `company_man` VARCHAR(20) NOT NULL DEFAULT '' COMMENT '公司的法定人',
  `company_man_id_card` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '公司的法定人的身份证',
  `business_license` VARCHAR(250) NOT NULL DEFAULT '' COMMENT '公司的营业执照',
...
CREATE TABLE `tb_greetings` (
  `id` VARCHAR(50) NOT NULL COMMENT '主键',
  `time_quantum` TINYINT(1) NOT NULL DEFAULT '0' COMMENT '时间段：0早晨，1上午，2中午，3下午，4晚上',
...
CREATE TABLE `tb_industry` (
  `id` VARCHAR(50) NOT NULL COMMENT '主键',
  `industry_type` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '行业类型',
  `one_level` VARCHAR(50) NOT NULL DEFAULT '0' COMMENT '一级id',
  `create_date` datetime NOT NULL COMMENT '创建时间',
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_invoice_ladder_price` (
  ...
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_icr1qhlwx3lsd0terqn7w65k1` (`tax_id`,`start_money`,`end_money`, `packaeg_status`)
...
CREATE TABLE `tb_dict` (
  ...
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_icr1qhlwx3lsd0terqn7w65k1` (`code`,`dict_key`) USING BTREE
...
CREATE TABLE `tb_merchant_catalog` (
  `id` VARCHAR(50) NOT NULL COMMENT '主键',
  `merchant_id` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '商户id',
  `catalog_id` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '类目id',
  `create_date` datetime NOT NULL COMMENT '创建时间',
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_merchant_role` (
  `id` VARCHAR(50) NOT NULL COMMENT '主键',
  `role_name` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '角色名称',
  `role_position` VARCHAR(200) NOT NULL DEFAULT '' COMMENT '角色的职位',
  `create_date` datetime NOT NULL COMMENT '创建时间',
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_merchant_role_menu` (
  ...
  `merchant_role_id` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '角色ID',
  `create_date` datetime NOT NULL COMMENT '创建时间',
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_payment_order_subpackage` (
  ...
  `real_money` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '支付金额',
  `tax_id` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '平台服务商ID',
  `subpackage_payment` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '分包支付回单（存储位置）',
  `task_id` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '关联的任务(可以不关联)',
  `payment_mode` TINYINT(1) NOT NULL DEFAULT '0' COMMENT '0线下支付',
  `payment_order_status` TINYINT(1) NOT NULL DEFAULT '0' COMMENT '支付订单的状态1待支付，2已支付',
  `payment_date` datetime DEFAULT NULL COMMENT '支付时间',
  `create_date` datetime NOT NULL COMMENT '创建时间',
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
