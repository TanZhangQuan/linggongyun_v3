...
Date: 2021-02-07 14:45:59
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `tb_achievement_statistics`
-- ----------------------------
...
--   `merchant_business` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '直属商户流水',
--   `agent_count` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '下级代理数',
--   `agent_business` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '下级代理流水',
--   `merchant_commission` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '直属商户流水提成',
--   `agent_commission` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '代理商流水提成',
--   `merchant_difference` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '商户差价提成',
--   `agent_difference` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '代理商差价提成',
--   `total_commission` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '总提成',
--   `agent_rate` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '代理商流水提成汇率',
--   `merchant_rate` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '直属商户流水提成汇率',
...
-- ----------------------------
-- Records of tb_achievement_statistics
-- ----------------------------
...
-- ----------------------------
-- Table structure for `tb_agent_ladder_service`
-- ----------------------------
...
--   `start_money` decimal(12,2) DEFAULT NULL COMMENT '开始的金额',
--   `end_money` decimal(12,2) DEFAULT NULL COMMENT '结束的金额',
--   `service_charge` decimal(12,2) DEFAULT NULL COMMENT '服务费（如7.5，不需把百分数换算成小数）',
...
-- ----------------------------
-- Records of tb_agent_ladder_service
-- ----------------------------

-- ----------------------------
-- Table structure for `tb_agent_tax`
-- ----------------------------
...
--   `service_charge` decimal(12,2) DEFAULT NULL COMMENT '一口价的服务费(如果为梯度价这为空)',
...
-- ----------------------------
-- Table structure for `tb_commission_proportion`
-- ----------------------------
...
--   `start_money` decimal(12,2) NOT NULL COMMENT '区间开始金额',
--   `end_money` decimal(12,2) NOT NULL COMMENT '区间结束金额',
--   `commission_rate` decimal(12,2) NOT NULL COMMENT '纳税率',
--   `create_date` datetime NOT NULL COMMENT '创建时间',
--   `update_date` datetime NOT NULL COMMENT '修改时间',
--   PRIMARY KEY (`id`)
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Records of tb_commission_proportion
-- ----------------------------
...
CREATE TABLE `tb_payment_inventory` (
  ...
  `trade_fail_reason` varchar(100) NOT NULL DEFAULT '' COMMENT '交易失败原因',
--   `agent_difference` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '代理商差额佣金',
--   `salesman_difference` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '业务员差额佣金',
  `create_date` datetime NOT NULL COMMENT '创建时间',
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_icr1qhlwx3lsd0terqn7w65k1` (`trade_no`)
...
CREATE TABLE `tb_payment_order` (
  ...
  `trade_fail_reason` varchar(100) NOT NULL DEFAULT '' COMMENT '交易失败原因',
--   `total_agent_difference` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '代理商差额佣金',
--   `total_salesman_difference` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '业务员差额佣金',
  `create_date` datetime NOT NULL COMMENT '创建时间',
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_icr1qhlwx3lsd0terqn7w65k1` (`trade_no`)
