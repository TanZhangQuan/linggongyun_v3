...
public class StructureController {
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "managersId", value = "业务员的ID", required = true)})
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "salesManId", value = "业务员ID", required = true)})
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "salesManId", value = "业务员ID", required = true), @ApiImplicitParam(name = "page", value = "当前页数", required = true), @ApiImplicitParam(name = "pageSize", value = "一页的条数", required = true)})
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "paymentOrderId", value = "支付订单", required = true), @ApiImplicitParam(name = "packageStatus", value = "合作类型", required = true)})
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "agentId", value = "代理商的ID", required = true)})
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "AgentId", value = "代理商ID", required = true)})
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "agentId", value = "代理商ID", required = true), @ApiImplicitParam(name = "page", value = "当前页数", required = true), @ApiImplicitParam(name = "pageSize", value = "一页的条数", required = true)})
