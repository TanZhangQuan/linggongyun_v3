...
public class PaymentOrderManyController {
    ...
    @ApiImplicitParams(value={@ApiImplicitParam(name="paymentOrderDto",value = "查询条件",required = true)})
    ...
    @ApiImplicitParams(value={@ApiImplicitParam(name="PaymentOrderMany",value = "支付订单",required = true),@ApiImplicitParam(name="paymentInventories",value = "支付订单清单",required = true)})
