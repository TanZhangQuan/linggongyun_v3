...
public class TemplateFileController {
    ...
    @ApiOperation(value = "下载总包+分包支付清单模板", notes = "下载总包+分包支付清单模板", httpMethod = "GET")
    ...
    @ApiOperation(value = "下载总包+分包交付支付验收单", notes = "下载总包+分包交付支付验收单", httpMethod = "GET")
    ...
    @ApiOperation(value = "下载众包支付清单模板", notes = "下载众包支付清单模板", httpMethod = "GET")
    ...
    @ApiOperation(value = "下载众包交付支付验收单", notes = "下载众包交付支付验收单", httpMethod = "GET")
    ...
    @ApiOperation(value = "下载导入创客模板", notes = "下载导入创客模板", httpMethod = "GET")
