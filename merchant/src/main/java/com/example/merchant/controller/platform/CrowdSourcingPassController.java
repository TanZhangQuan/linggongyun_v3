...
import com.example.merchant.controller.merchant.InvoiceMerchantController;
...
public class CrowdSourcingPassController {
    ...
    private static Logger logger = LoggerFactory.getLogger(InvoiceMerchantController.class);
