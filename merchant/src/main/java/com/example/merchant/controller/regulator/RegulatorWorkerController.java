...
public class RegulatorWorkerController {
    ...
    public ReturnJson exportRegulatorWorker(@NotBlank(message = "创客ID不能为空！") @RequestParam(required = false) String workerIds, @NotBlank(message = "管理部门ID不能为空！") @RequestParam(required = false) String regulatorId, HttpServletResponse response) {
    ...
    public ReturnJson countRegulatorWorker(@NotBlank(message = "管理部门ID不能为空！") @RequestParam(required = false) String regulatorId) {
    ...
    public ReturnJson countRegulatorWorkerInfo(@NotBlank(message = "管理部门ID不能为空！") @RequestParam(required = false) String regulatorId, @NotBlank(message = "创客ID不能为空！") @RequestParam(required = false) String workerId) {
