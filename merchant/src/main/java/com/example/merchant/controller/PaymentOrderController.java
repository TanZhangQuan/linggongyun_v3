...
public class PaymentOrderController {
    ...
    @ApiImplicitParams(value={@ApiImplicitParam(name="paymentOrder",value = "新建或修改的支付订单",required = true),
            @ApiImplicitParam(name="paymentInventories",value = "支付清单",required = true)})
