...
public class AccountParamUtil {
     ...
     */
    public static String bankAuthenticationParam(String workerName, String idCard, String bankCode) {
        JSONObject json = new JSONObject();
        json.put("name", workerName);
        json.put("idNo", idCard);
        json.put("cardNo", bankCode);
        return json.toString();
    }
