...
import com.example.common.util.HTTPHelper;
...
public class Test {
    ...
    public static void main(String[] args) {
        // 应用ID
        String appId = "5111617720";
        // 应用密钥
        String appKey = "872614e259eded522417c76ad0fb06f0";
        // 接口调用域名
...
//    testGet(appId, appKey, host, accountId);
    ...
    public static void testPost(String appId, String appKey, String host) {
        // 个人创建账号接口地址
        String accountsApi = "/v2/identity/verify/individual/bank3Factors";
        // 个人创建账号接口请求地址
        ...
        try {
            ...
            String param = AccountParamUtil.bankAuthenticationParam("workerName", "idCard", "bankCode");
            JSONObject reqBodyObj = JSONObject.fromObject(param);
//            JSONObject reqBodyObj = new JSONObject();
//            reqBodyObj.put("name", "workerName");
//            reqBodyObj.put("idNo", "idCard");
//            reqBodyObj.put("cardNo", "bankCode");
