...
public class AccountHelper {
     ...
     * @param idCard     创客身份证号码
     * @param bankCode   创客银行卡号
     * @Return com.alibaba.fastjson.JSONObject
     * @Author 忆惜
     * @Date 2020/11/2 10:21
     */
    public static JSONObject bankAuthentication(String workerName, String idCard, String bankCode) throws DefineException {
        String param = AccountParamUtil.bankAuthenticationParam(workerName, idCard, bankCode);
        JSONObject json = HttpHelper.doCommHttp(RequestType.POST, ConfigConstant.bankAuthentication_URL(), param);
        return json;
    }
