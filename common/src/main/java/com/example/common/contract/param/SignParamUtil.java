package com.example.common.contract.param;
...
import com.example.common.contract.domain.signarea.PosBean;
import com.example.common.contract.domain.signarea.Signfield;
import com.example.common.contract.domain.signflow.ConfigInfo;
import com.example.common.contract.domain.signflow.SignFlowStart;
...
public class SignParamUtil {
    ...
    private static SignFlowStart createSignFlowStart() {
        ConfigInfo cfgInfo = new ConfigInfo(EqianbaoConfig.getAsyncNotifyUrl(), "1,2", null, null);
    ...
    private static List<Signfield> createPlatformSignfields(List<String> fileIds, List<String> sealIds)
        ...
        PosBean posBean1 = new PosBean(EqianbaoConfig.getPlatformSignPosPage(), EqianbaoConfig.getPlatformSignPosX(), EqianbaoConfig.getPlatformSignPosY(), null, null);
    ...
    private static List<Signfield> createSignerAutoSignfields(List<String> fileIds, List<String> authorizedAccountIds,
        ...
        List<Signfield> list = Lists.newArrayList();
        PosBean posBean1 = new PosBean(EqianbaoConfig.getSignerAutoSignPosPage(), EqianbaoConfig.getSignerAutoSignPosX(), EqianbaoConfig.getSignerAutoSignPosY(), null, null);
    ...
    private static List<Signfield> createSignerHandSignfields(List<String> fileIds, List<String> signerAccountIds,
        ...
        List<Signfield> list = Lists.newArrayList();
        PosBean posBean1 = new PosBean(EqianbaoConfig.getSignerHandSignPosPage(), EqianbaoConfig.getSignerHandSignPosX(), EqianbaoConfig.getSignerHandSignPosY(), null, null);
