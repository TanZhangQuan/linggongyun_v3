...
public class SftpUtil {
    ...
    public List<String> batchDownLoadFile(String remotePath, String localPath, String fileFormat, String fileEndFormat, boolean del) {
        ...
        try {
            ...
            // sftp.cd(remotePath);
            if (vector.size() > 0) {
                System.out.println("本次处理文件个数不为零,开始下载...fileSize=" + vector.size());
            ...
            log.info("download file is success:remotePath=" + remotePath + " and localPath=" + localPath + ", file size is" + vector.size());
        ...
        log.info(String.valueOf(filenames));
        return filenames;
    }
    ...
    public boolean downloadFile(String remotePath, String remoteFileName, String localPath, String localFileName) {
        ...
        try {
            ...
            if (!file.exists()) {// 判断目录是否存在
                FileUtil.mkdirs(localPath + localFileName);
            }
